...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-72px)] overflow-hidden" style={{ backgroundColor: 'rgb(5, 7, 10)' }}>
      ...
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-cyan-500/10 rounded-full blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '2s' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 w-full items-center">
          ...
          <div className="flex flex-col justify-center space-y-5">
            ...
            <p className="text-base md:text-lg text-gray-300 leading-snug max-w-xl opacity-80">
              ResQ is a disaster response and student safety platform that ingests and standardizes your emergency data and tracks changes in real time during crisis situations.
            </p>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full max-w-lg max-h-lg">
                  ...
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(6, 28, 55, 0.4) 0%, rgba(23, 37, 84, 0.3) 100%)',
                      boxShadow: `
                  ...
                  <svg className="absolute inset-0 w-full h-full" style={{ filter: 'drop-shadow(0 0 10px rgba(34, 211, 238, 0.3))' }}>
                    {/* Line to AWS */}
                    <path
                    ...
                    <defs>
                      <linearGradient id="gradientCyanOrange" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor="rgb(34, 211, 238)" stopOpacity="1" />
                        <stop offset="100%" stopColor="rgb(249, 115, 22)" stopOpacity="1" />
                      </linearGradient>
                      <linearGradient id="gradientCyanBlue" x1="100%" y1="100%" x2="0%" y2="0%">
                        <stop offset="0%" stopColor="rgb(34, 211, 238)" stopOpacity="1" />
                  ...
                  <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-cyan-400 rounded-full animate-ping" style={{ animationDuration: '2s', opacity: 0.7 }} />
                  <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-purple-400 rounded-full animate-ping" style={{ animationDuration: '3s', animationDelay: '0.5s', opacity: 0.6 }} />
                  <div className="absolute bottom-1/4 right-1/3 w-1 h-1 bg-orange-400 rounded-full animate-ping" style={{ animationDuration: '2.5s', animationDelay: '1s', opacity: 0.5 }} />
                </div>
              </div>
            </div>
          </div>
